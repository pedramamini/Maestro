...
describe('MarkdownRenderer', () => {
	...
	describe('raw HTML handling with allowRawHtml', () => {
		it('renders raw HTML inline elements when allowRawHtml is true', () => {
			const content = 'Hello <b>bold</b> world';
			const { container } = render(
				<MarkdownRenderer {...defaultProps} content={content} allowRawHtml={true} />
			);
		...
		it('passes through block HTML elements when allowRawHtml is true', () => {
			const content = 'Text <div class="custom">inner</div> more text';
			const { container } = render(
				<MarkdownRenderer {...defaultProps} content={content} allowRawHtml={true} />
			);
