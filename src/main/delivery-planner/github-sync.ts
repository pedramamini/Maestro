...
DELIVERY_PLANNER_GITHUB_OWNER,
} from './github-safety';

export const DELIVERY_PLANNER_GITHUB_PROJECT_OWNER: string = DELIVERY_PLANNER_GITHUB_OWNER;
/** Default project number; override via MAESTRO_GITHUB_PROJECT_NUMBER env var. */
export const DELIVERY_PLANNER_GITHUB_PROJECT_NUMBER: number = parseInt(process.env.MAESTRO_GITHUB_PROJECT_NUMBER ?? '7', 10);
export const DELIVERY_PLANNER_GITHUB_PROJECT_TITLE: string = process.env.MAESTRO_GITHUB_PROJECT_TITLE ?? 'Maestro Features';
