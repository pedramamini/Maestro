...
export { OpenClawSessionStorage } from './openclaw-session-storage';
...
import { OpenClawSessionStorage } from './openclaw-session-storage';
...
export function initializeSessionStorages(options?: InitializeSessionStoragesOptions): void {
	...
	registerSessionStorage(new OpenClawSessionStorage());
}
