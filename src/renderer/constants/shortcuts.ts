...
export const DEFAULT_SHORTCUTS: Record<string, Shortcut> = {
	...
	newInstance: { id: 'newInstance', label: 'New Agent', keys: ['Meta', 'n'], scope: 'global' },
	newGroupChat: { id: 'newGroupChat', label: 'New Group Chat', keys: ['Alt', 'Meta', 'c'], scope: 'global' },
	killInstance: { id: 'killInstance', label: 'Remove', keys: ['Meta', 'Shift', 'Backspace'], scope: 'global' },
	moveToGroup: {
		id: 'moveToGroup',
	...
	systemLogs: { id: 'systemLogs', label: 'System Log Viewer', keys: ['Alt', 'Meta', 'l'], scope: 'global' },
	processMonitor: {
		id: 'processMonitor',
	...
	usageDashboard: { id: 'usageDashboard', label: 'Usage Dashboard', keys: ['Alt', 'Meta', 'u'], scope: 'global' },
	...
	openWizard: { id: 'openWizard', label: 'New Agent Wizard', keys: ['Meta', 'Shift', 'n'], scope: 'global' },
	fuzzyFileSearch: { id: 'fuzzyFileSearch', label: 'Fuzzy File Search', keys: ['Meta', 'g'] },
	toggleBookmark: { id: 'toggleBookmark', label: 'Toggle Bookmark', keys: ['Meta', 'Shift', 'b'], scope: 'global' },
	openSymphony: { id: 'openSymphony', label: 'Maestro Symphony', keys: ['Meta', 'Shift', 'y'], scope: 'global' },
	directorNotes: {
		id: 'directorNotes',
