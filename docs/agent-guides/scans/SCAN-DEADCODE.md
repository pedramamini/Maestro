...
- ~~`ORPHANED_SESSION_ID`~~ **REMOVED (re-vet 2026-03-28): used in `main/ipc/handlers/history.ts:18`**
- `DEFAULT_PAGINATION`
...
**Total: 43 dead shared exports across 18 files.** _(re-vetted 2026-03-28: ORPHANED_SESSION_ID removed, was false positive)_
