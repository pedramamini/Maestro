...
These shortcuts are specific to terminal mode (xterm.js tabs):

| Action                          | macOS           | Windows/Linux   |
| ------------------------------- | --------------- | --------------- |
| New Terminal Tab                | `Ctrl+Shift+\`` | `Ctrl+Shift+\`` |
| Clear Terminal                  | `Cmd+K`         | `Ctrl+K`        |
| Open Terminal Search            | `Cmd+F`         | `Ctrl+F`        |
| Next Terminal Search Result     | `Cmd+G`         | `Ctrl+G`        |
| Previous Terminal Search Result | `Cmd+Shift+G`   | `Ctrl+Shift+G`  |

Terminal mode also uses the same tab management shortcuts above for tab switching, close/reopen, and tab index jumps.
