...
1. Run PM audit/health in Maestro, or inspect from a shell with `{{MAESTRO_CLI_PATH}} fleet board --project <path> --json`.
2. Release stale Work Graph claims in Maestro or with `{{MAESTRO_CLI_PATH}} fleet release <workItemId> --json`.
